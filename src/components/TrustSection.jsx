...
const trust = [
  { Icon: IconLock,    label: 'Disulitkan SSL' },
  { Icon: IconBolt,    label: 'Pengeluaran Pantas' },
  { Icon: IconShield,  label: 'Main Bertanggungjawab' },
  { Icon: IconSupport, label: 'Sokongan 24/7' },
]
  ...
  return (
    <section className="py-12 px-6">
      ...
      <div className="max-w-md mx-auto">
        ...
        >
          <h2 className="font-display text-3xl text-ice tracking-widest">DIPERCAYAI · SELAMAT · TERJAMIN</h2>
          <p className="font-body text-ice/40 text-sm mt-1">Berlesen &amp; Dikawal · Malaysia &amp; Singapura</p>
        </motion.div>
        ...
        >
          18+ sahaja. Main dengan bertanggungjawab. i88 menyokong permainan selamat di Malaysia &amp; Singapura.
